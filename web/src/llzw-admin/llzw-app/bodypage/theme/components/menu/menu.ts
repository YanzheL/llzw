...
export const verticalMenuItems = [
    ...
    new Menu(3, '卖家业务', null, null, 'computer', null, true, 0),
    new Menu(4, '商品', '/seller/admin/admin-works/products', null, 'keyboard', null, false, 3),
    new Menu(5, '库存', '/seller/admin/admin-works/stocks', null, 'card_membership', null, false, 3),
    new Menu(6, '订单', '/seller/admin/admin-works/orders', null, 'list', null, false, 3),
    new Menu(7, '支付', '/seller/admin/admin-works/payments', null, 'grid_on', null, false, 3),
    new Menu(8, 'Tabs', '/ui/tabs', null, 'tab', null, false, 3),
    new Menu(9, 'Expansion Panel', '/ui/expansion-panel', null, 'dns', null, false, 3),
    new Menu(10, '表单测试', null, null, 'computer', null, true, 0),
    new Menu(11, '登录', '/seller/admin/admin-forms/login', null, 'data_usage', null, false, 10),
    /*
    new Menu(12, 'Dialog', '/ui/dialog', null, 'open_in_new', null, false, 3),
    new Menu(13, 'Tooltip', '/ui/tooltip', null, 'chat_bubble', null, false, 3),

    new Menu(14, 'Users', '/users', null, 'supervisor_account', null, false, 0),
