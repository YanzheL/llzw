...
/*
	...
	createOrder(order): Observable<OrderModel> {
		...
		return this.http.post<OrderModel>(API_PRODUCTS_URL, order, { headers: httpHeaders });
	}

	// READ
	getAllOrders(): Observable<OrderModel[]> {
		return this.http.get<OrderModel[]>(API_PRODUCTS_URL);
	}

	getOrderById(orderId: number): Observable<OrderModel> {
		return this.http.get<OrderModel>(API_PRODUCTS_URL + `/${orderId}`);
	}
*/
